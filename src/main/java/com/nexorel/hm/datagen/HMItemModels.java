...
public class HMItemModels extends ItemModelProvider {

    public HMItemModels(DataGenerator generator, ExistingFileHelper existingFileHelper) {
        super(generator, HyperMess.MODID, existingFileHelper);
    }
